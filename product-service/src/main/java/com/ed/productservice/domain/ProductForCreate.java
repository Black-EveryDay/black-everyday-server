...
public class ProductForCreate {
  ...
  public ProductForCreate(Long brandId, String name, int price, String description,
      ProductStatus status, ProductCategory category, String color, Integer quantity,
      String image) {
