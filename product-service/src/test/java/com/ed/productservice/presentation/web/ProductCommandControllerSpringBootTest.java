...
class ProductCommandControllerSpringBootTest {
    ...
    void t1() throws Exception {
        ...
        String requestBody = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(topProductRequest);
    ...
    void t3() throws Exception {
        ...
        String requestBody = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(bottomProductRequest);

        mockMvc.perform(post("/api/v1/products/bottom").contentType(MediaType.APPLICATION_JSON).content(requestBody))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.success").value(true))
                .andExpect(jsonPath("$.body.productPublicId").exists())
                .andExpect(jsonPath("$.body.createdAt").exists())
