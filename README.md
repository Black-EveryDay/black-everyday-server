...
*   쿠폰 템플릿 생성
    *  발급될 쿠폰의 할인율, 할인 금액, 유효기간 을 설정합니다.
*   쿠폰 발급
    *  쿠폰 템플릿 기반으로 유저가 사용할 수 있는 쿠폰을 발급합니다.
*   쿠폰 사용
    *  주문 생성 전 쿠폰의 사용 가능여부를 확인 및 사용처리 합니다.
    *  주문 취소 시 쿠폰의 사용처리 여부를 취소합니다.
...
*   선착순 참여 이벤트
    *  선착순으로 이벤트에 참여하면 할인쿠폰을 발급 합니다.
    *  10만명의 이벤트 참여 유저를 처리합니다.
